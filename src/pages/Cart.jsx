    ...
    <div id="books__body">
      <main id="books">
        <div className="books__container">
          <div className="row book__selected--top">
            <h2 className="class__title">Cart</h2>
          </div>
          <div className="cart">
            ...
            <div className="cart__body">
              {/* remember when you map you need a return!! */}
              {cart.map((book) => {
                return (
                  <div className="cart__item">
                    ...
                    <div className="cart__quantity">
                      <input
                        ...
                        max={99}
                        class="cart__input"
                        // The value is added so when you click number of books it mounts and reflects
                        // in the cart:
                        value={book.quantity}
                        onChange={(event) =>
            ...
            { cart.length === 0 && (
                ...
                <h2>You don't have books in your cart!</h2>
                <Link to="/books">
